...
function constructo_cpt_testies()
{
    ...
    $labels = array(
        'name' => _x('Testimonials', 'Post Type General Name', 'constructo'),
        'singular_name' => _x('Testimonial', 'Post Type Singular Name', 'constructo'),
        'menu_name' => __('Testimonials', 'constructo'),
        'name_admin_bar' => __('Testimonials', 'constructo'),
